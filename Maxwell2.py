...
while True:
   ...
   duplicate_image.save(os.path.join(save_path, randomlist1 + randomlist2 + randomlist3 + randomlist3 + randomlist4 + randomlist5 +
    randomlist6 + randomlist6 + randomlist7 + randomlist8 + randomlist9 + randomlist10 + '.png'))
